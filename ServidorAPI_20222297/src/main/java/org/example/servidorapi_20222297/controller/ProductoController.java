package org.example.servidorapi_20222297.controller;

import org.example.servidorapi_20222297.entity.Producto;
import org.example.servidorapi_20222297.repository.ProductoRepository;
...
public class ProductoController {
    ...
    public ResponseEntity<?> getById(@PathVariable Integer id) {
        return productRepository.findById(id)
                ...
                .orElseGet(() -> ResponseEntity.badRequest()
                        .body(Map.of("mensaje", "Producto con id " + id + " no encontrado")));
    }
    ...
    public ResponseEntity<?> delete(@PathVariable Integer id) {
        ...
        try {
            ...
            return ResponseEntity.badRequest()
                    .body(Map.of("mensaje", "No se puede eliminar el producto por restricción referencial"));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Map.of("mensaje", "Error al eliminar el producto: " + e.getMessage()));
        }
    }
}
